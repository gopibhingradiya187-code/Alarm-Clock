...
import static com.cubealarm.clock.settings.PreferencesKeys.KEY_ALARM_BACKGROUND_AMOLED_COLOR;
import static com.cubealarm.clock.settings.PreferencesKeys.KEY_ALARM_BACKGROUND_COLOR;
import static com.cubealarm.clock.settings.PreferencesKeys.KEY_ALARM_BLUR_INTENSITY;
import static com.cubealarm.clock.settings.PreferencesKeys.KEY_ALARM_BUTTON_COLOR;
import static com.cubealarm.clock.settings.PreferencesKeys.KEY_ALARM_CLOCK_COLOR;
import static com.cubealarm.clock.settings.PreferencesKeys.KEY_ALARM_CLOCK_DIAL;
import static com.cubealarm.clock.settings.PreferencesKeys.KEY_ALARM_CLOCK_DIAL_MATERIAL;
import static com.cubealarm.clock.settings.PreferencesKeys.KEY_ALARM_CLOCK_SECOND_HAND;
import static com.cubealarm.clock.settings.PreferencesKeys.KEY_ALARM_DIGITAL_CLOCK_FONT_SIZE;
import static com.cubealarm.clock.settings.PreferencesKeys.KEY_ALARM_CLOCK_STYLE;
import static com.cubealarm.clock.settings.PreferencesKeys.KEY_ALARM_DISPLAY_TEXT_SHADOW;
import static com.cubealarm.clock.settings.PreferencesKeys.KEY_ALARM_SECOND_HAND_COLOR;
import static com.cubealarm.clock.settings.PreferencesKeys.KEY_ALARM_BACKGROUND_IMAGE;
import static com.cubealarm.clock.settings.PreferencesKeys.KEY_ALARM_SHADOW_COLOR;
import static com.cubealarm.clock.settings.PreferencesKeys.KEY_ALARM_SHADOW_OFFSET;
import static com.cubealarm.clock.settings.PreferencesKeys.KEY_DISMISS_BUTTON_COLOR;
import static com.cubealarm.clock.settings.PreferencesKeys.KEY_DISMISS_TITLE_COLOR;
import static com.cubealarm.clock.settings.PreferencesKeys.KEY_DISPLAY_ALARM_SECOND_HAND;
import static com.cubealarm.clock.settings.PreferencesKeys.KEY_DISPLAY_RINGTONE_TITLE;
import static com.cubealarm.clock.settings.PreferencesKeys.KEY_ENABLE_ALARM_BLUR_EFFECT;
import static com.cubealarm.clock.settings.PreferencesKeys.KEY_PREVIEW_ALARM;
import static com.cubealarm.clock.settings.PreferencesKeys.KEY_RINGTONE_TITLE_COLOR;
import static com.cubealarm.clock.settings.PreferencesKeys.KEY_SLIDE_ZONE_COLOR;
import static com.cubealarm.clock.settings.PreferencesKeys.KEY_SNOOZE_BUTTON_COLOR;
import static com.cubealarm.clock.settings.PreferencesKeys.KEY_SNOOZE_TITLE_COLOR;
import static com.cubealarm.clock.settings.PreferencesKeys.KEY_SWIPE_ACTION;
