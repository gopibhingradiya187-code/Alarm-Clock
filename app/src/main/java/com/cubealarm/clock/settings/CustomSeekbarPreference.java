...
import static com.cubealarm.clock.settings.PreferencesDefaultValues.DEFAULT_ALARM_SHADOW_OFFSET;
import static com.cubealarm.clock.settings.PreferencesDefaultValues.DEFAULT_BLUR_INTENSITY;
import static com.cubealarm.clock.settings.PreferencesDefaultValues.DEFAULT_ALARM_DIGITAL_CLOCK_FONT_SIZE;
import static com.cubealarm.clock.settings.PreferencesDefaultValues.DEFAULT_ALARM_TITLE_FONT_SIZE_PREF;
import static com.cubealarm.clock.settings.PreferencesDefaultValues.DEFAULT_BLUETOOTH_VOLUME;
import static com.cubealarm.clock.settings.PreferencesDefaultValues.DEFAULT_MATERIAL_YOU_WIDGET_BACKGROUND_CORNER_RADIUS;
import static com.cubealarm.clock.settings.PreferencesDefaultValues.DEFAULT_SCREENSAVER_BRIGHTNESS;
import static com.cubealarm.clock.settings.PreferencesDefaultValues.DEFAULT_SHAKE_INTENSITY;
import static com.cubealarm.clock.settings.PreferencesDefaultValues.DEFAULT_TIMER_SHAKE_INTENSITY;
import static com.cubealarm.clock.settings.PreferencesDefaultValues.DEFAULT_WIDGETS_FONT_SIZE;
import static com.cubealarm.clock.settings.PreferencesDefaultValues.DEFAULT_WIDGET_BACKGROUND_CORNER_RADIUS;
import static com.cubealarm.clock.settings.PreferencesKeys.KEY_ALARM_BLUR_INTENSITY;
import static com.cubealarm.clock.settings.PreferencesKeys.KEY_ALARM_DIGITAL_CLOCK_FONT_SIZE;
import static com.cubealarm.clock.settings.PreferencesKeys.KEY_ALARM_SHADOW_OFFSET;
import static com.cubealarm.clock.settings.PreferencesKeys.KEY_ALARM_TITLE_FONT_SIZE_PREF;
import static com.cubealarm.clock.settings.PreferencesKeys.KEY_BLUETOOTH_VOLUME;
import static com.cubealarm.clock.settings.PreferencesKeys.KEY_DIGITAL_WIDGET_BACKGROUND_CORNER_RADIUS;
import static com.cubealarm.clock.settings.PreferencesKeys.KEY_MATERIAL_YOU_DIGITAL_WIDGET_BACKGROUND_CORNER_RADIUS;
import static com.cubealarm.clock.settings.PreferencesKeys.KEY_MATERIAL_YOU_NEXT_ALARM_WIDGET_BACKGROUND_CORNER_RADIUS;
import static com.cubealarm.clock.settings.PreferencesKeys.KEY_MATERIAL_YOU_VERTICAL_DIGITAL_WIDGET_BACKGROUND_CORNER_RADIUS;
import static com.cubealarm.clock.settings.PreferencesKeys.KEY_NEXT_ALARM_WIDGET_BACKGROUND_CORNER_RADIUS;
import static com.cubealarm.clock.settings.PreferencesKeys.KEY_SCREENSAVER_BRIGHTNESS;
import static com.cubealarm.clock.settings.PreferencesKeys.KEY_SHAKE_INTENSITY;
import static com.cubealarm.clock.settings.PreferencesKeys.KEY_TIMER_SHAKE_INTENSITY;
import static com.cubealarm.clock.settings.PreferencesKeys.KEY_VERTICAL_WIDGET_BACKGROUND_CORNER_RADIUS;
import static com.cubealarm.clock.utils.RingtoneUtils.ALARM_PREVIEW_DURATION_MS;
...
import com.cubealarm.clock.ringtone.RingtonePreviewKlaxon;
