...
import static com.cubealarm.clock.settings.PreferencesKeys.KEY_MATERIAL_YOU_DIGITAL_WIDGET_APPLY_HORIZONTAL_PADDING;
import static com.cubealarm.clock.settings.PreferencesKeys.KEY_MATERIAL_YOU_DIGITAL_WIDGET_BACKGROUND_CORNER_RADIUS;
import static com.cubealarm.clock.settings.PreferencesKeys.KEY_MATERIAL_YOU_DIGITAL_WIDGET_CUSTOMIZE_BACKGROUND_CORNER_RADIUS;
import static com.cubealarm.clock.settings.PreferencesKeys.KEY_MATERIAL_YOU_DIGITAL_WIDGET_CUSTOM_BACKGROUND_COLOR;
import static com.cubealarm.clock.settings.PreferencesKeys.KEY_MATERIAL_YOU_DIGITAL_WIDGET_CUSTOM_CITY_CLOCK_COLOR;
import static com.cubealarm.clock.settings.PreferencesKeys.KEY_MATERIAL_YOU_DIGITAL_WIDGET_CUSTOM_CITY_NAME_COLOR;
import static com.cubealarm.clock.settings.PreferencesKeys.KEY_MATERIAL_YOU_DIGITAL_WIDGET_CUSTOM_CLOCK_COLOR;
import static com.cubealarm.clock.settings.PreferencesKeys.KEY_MATERIAL_YOU_DIGITAL_WIDGET_CUSTOM_DATE_COLOR;
import static com.cubealarm.clock.settings.PreferencesKeys.KEY_MATERIAL_YOU_DIGITAL_WIDGET_CUSTOM_NEXT_ALARM_COLOR;
import static com.cubealarm.clock.settings.PreferencesKeys.KEY_MATERIAL_YOU_DIGITAL_WIDGET_DEFAULT_BACKGROUND_COLOR;
import static com.cubealarm.clock.settings.PreferencesKeys.KEY_MATERIAL_YOU_DIGITAL_WIDGET_DEFAULT_CITY_CLOCK_COLOR;
import static com.cubealarm.clock.settings.PreferencesKeys.KEY_MATERIAL_YOU_DIGITAL_WIDGET_DEFAULT_CITY_NAME_COLOR;
import static com.cubealarm.clock.settings.PreferencesKeys.KEY_MATERIAL_YOU_DIGITAL_WIDGET_DEFAULT_CLOCK_COLOR;
import static com.cubealarm.clock.settings.PreferencesKeys.KEY_MATERIAL_YOU_DIGITAL_WIDGET_DEFAULT_DATE_COLOR;
import static com.cubealarm.clock.settings.PreferencesKeys.KEY_MATERIAL_YOU_DIGITAL_WIDGET_DEFAULT_NEXT_ALARM_COLOR;
import static com.cubealarm.clock.settings.PreferencesKeys.KEY_MATERIAL_YOU_DIGITAL_WIDGET_DISPLAY_BACKGROUND;
import static com.cubealarm.clock.settings.PreferencesKeys.KEY_MATERIAL_YOU_DIGITAL_WIDGET_DISPLAY_DATE;
import static com.cubealarm.clock.settings.PreferencesKeys.KEY_MATERIAL_YOU_DIGITAL_WIDGET_DISPLAY_NEXT_ALARM;
import static com.cubealarm.clock.settings.PreferencesKeys.KEY_MATERIAL_YOU_DIGITAL_WIDGET_HIDE_AM_PM;
import static com.cubealarm.clock.settings.PreferencesKeys.KEY_MATERIAL_YOU_DIGITAL_WIDGET_MAXIMUM_CLOCK_FONT_SIZE;
import static com.cubealarm.clock.settings.PreferencesKeys.KEY_MATERIAL_YOU_DIGITAL_WIDGET_SECONDS_DISPLAYED;
import static com.cubealarm.clock.settings.PreferencesKeys.KEY_MATERIAL_YOU_DIGITAL_WIDGET_WORLD_CITIES_DISPLAYED;
...
import com.cubealarm.clock.data.City;
import com.cubealarm.clock.data.DataModel;
import com.cubealarm.clock.data.SettingsDAO;
import com.cubealarm.clock.data.WidgetDAO;
import com.cubealarm.clock.utils.SdkUtils;
import com.cubealarm.clock.utils.Utils;
import com.cubealarm.clock.utils.WidgetUtils;
import com.cubealarm.clock.widgets.materialyouwidgets.MaterialYouDigitalAppWidgetProvider;
...
public class MaterialYouDigitalWidgetSettingsFragment extends ScreenFragment
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mCustomizeBackgroundCornerRadiusPref = findPreference(KEY_MATERIAL_YOU_DIGITAL_WIDGET_CUSTOMIZE_BACKGROUND_CORNER_RADIUS);
        mBackgroundCornerRadiusPref = findPreference(KEY_MATERIAL_YOU_DIGITAL_WIDGET_BACKGROUND_CORNER_RADIUS);
    ...
    public boolean onPreferenceChange(Preference pref, Object newValue) {
        ...
        case KEY_MATERIAL_YOU_DIGITAL_WIDGET_SECONDS_DISPLAYED, KEY_MATERIAL_YOU_DIGITAL_WIDGET_HIDE_AM_PM,
            ...
            case KEY_MATERIAL_YOU_DIGITAL_WIDGET_DISPLAY_BACKGROUND -> {
                ...
                boolean isCustomColor = !WidgetDAO.isMaterialYouDigitalWidgetDefaultBackgroundColor(mPrefs);
                boolean isRadiusCustomizable = WidgetDAO.isMaterialYouDigitalWidgetBackgroundCornerRadiusCustomizable(mPrefs);
            ...
            case KEY_MATERIAL_YOU_DIGITAL_WIDGET_CUSTOMIZE_BACKGROUND_CORNER_RADIUS -> {
            ...
            case KEY_MATERIAL_YOU_DIGITAL_WIDGET_DEFAULT_BACKGROUND_COLOR -> {
                ...
                boolean displayBackground = WidgetDAO.isBackgroundDisplayedOnMaterialYouDigitalWidget(mPrefs);
                boolean isRadiusCustomizable = WidgetDAO.isMaterialYouDigitalWidgetBackgroundCornerRadiusCustomizable(mPrefs);
    ...
    private void setupPreferences() {
        ...
        boolean isBackgroundVisible = WidgetDAO.isBackgroundDisplayedOnMaterialYouDigitalWidget(mPrefs);
        boolean isBackgroundCornerRadiusCustomizable =
                WidgetDAO.isMaterialYouDigitalWidgetBackgroundCornerRadiusCustomizable(mPrefs);
        boolean isCustomColor = !WidgetDAO.isMaterialYouDigitalWidgetDefaultBackgroundColor(mPrefs);
    ...
    private void saveCheckedPreferenceStates() {
        ...
        mCustomizeBackgroundCornerRadiusPref.setChecked(WidgetDAO.isMaterialYouDigitalWidgetBackgroundCornerRadiusCustomizable(mPrefs));
