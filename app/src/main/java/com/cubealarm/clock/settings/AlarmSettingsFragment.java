...
import static com.cubealarm.clock.settings.PreferencesDefaultValues.ALARM_SNOOZE_DURATION_DISABLED;
import static com.cubealarm.clock.settings.PreferencesDefaultValues.DEFAULT_ALARM_SNOOZE_DURATION;
import static com.cubealarm.clock.settings.PreferencesDefaultValues.DEFAULT_ALARM_VOLUME;
import static com.cubealarm.clock.settings.PreferencesDefaultValues.DEFAULT_AUTO_SILENCE_DURATION;
import static com.cubealarm.clock.settings.PreferencesDefaultValues.DEFAULT_MISSED_ALARM_REPEAT_LIMIT;
import static com.cubealarm.clock.settings.PreferencesDefaultValues.DEFAULT_VIBRATION_START_DELAY;
import static com.cubealarm.clock.settings.PreferencesDefaultValues.DEFAULT_VOLUME_CRESCENDO_DURATION;
import static com.cubealarm.clock.settings.PreferencesDefaultValues.TIMEOUT_END_OF_RINGTONE;
import static com.cubealarm.clock.settings.PreferencesDefaultValues.TIMEOUT_NEVER;
import static com.cubealarm.clock.settings.PreferencesKeys.KEY_ALARM_DISPLAY_CUSTOMIZATION;
import static com.cubealarm.clock.settings.PreferencesKeys.KEY_ALARM_NOTIFICATION_REMINDER_TIME;
import static com.cubealarm.clock.settings.PreferencesKeys.KEY_ALARM_SNOOZE_DURATION;
import static com.cubealarm.clock.settings.PreferencesKeys.KEY_ALARM_VOLUME_CRESCENDO_DURATION;
import static com.cubealarm.clock.settings.PreferencesKeys.KEY_ALARM_VOLUME_SETTING;
import static com.cubealarm.clock.settings.PreferencesKeys.KEY_AUTO_ROUTING_TO_BLUETOOTH_DEVICE;
import static com.cubealarm.clock.settings.PreferencesKeys.KEY_AUTO_SILENCE_DURATION;
import static com.cubealarm.clock.settings.PreferencesKeys.KEY_BLUETOOTH_VOLUME;
import static com.cubealarm.clock.settings.PreferencesKeys.KEY_DEFAULT_ALARM_RINGTONE;
import static com.cubealarm.clock.settings.PreferencesKeys.KEY_DISPLAY_DISMISS_BUTTON;
import static com.cubealarm.clock.settings.PreferencesKeys.KEY_DISPLAY_ENABLED_ALARMS_FIRST;
import static com.cubealarm.clock.settings.PreferencesKeys.KEY_ENABLE_ALARM_FAB_LONG_PRESS;
import static com.cubealarm.clock.settings.PreferencesKeys.KEY_ENABLE_ALARM_VIBRATIONS_BY_DEFAULT;
import static com.cubealarm.clock.settings.PreferencesKeys.KEY_ENABLE_DELETE_OCCASIONAL_ALARM_BY_DEFAULT;
import static com.cubealarm.clock.settings.PreferencesKeys.KEY_ENABLE_PER_ALARM_AUTO_SILENCE;
import static com.cubealarm.clock.settings.PreferencesKeys.KEY_ENABLE_PER_ALARM_MISSED_REPEAT_LIMIT;
import static com.cubealarm.clock.settings.PreferencesKeys.KEY_ENABLE_PER_ALARM_SNOOZE_DURATION;
import static com.cubealarm.clock.settings.PreferencesKeys.KEY_ENABLE_PER_ALARM_VOLUME;
import static com.cubealarm.clock.settings.PreferencesKeys.KEY_ENABLE_PER_ALARM_VOLUME_CRESCENDO_DURATION;
import static com.cubealarm.clock.settings.PreferencesKeys.KEY_ENABLE_SNOOZED_OR_DISMISSED_ALARM_VIBRATIONS;
import static com.cubealarm.clock.settings.PreferencesKeys.KEY_FLIP_ACTION;
import static com.cubealarm.clock.settings.PreferencesKeys.KEY_MATERIAL_DATE_PICKER_STYLE;
import static com.cubealarm.clock.settings.PreferencesKeys.KEY_MATERIAL_TIME_PICKER_STYLE;
import static com.cubealarm.clock.settings.PreferencesKeys.KEY_MISSED_ALARM_REPEAT_LIMIT;
import static com.cubealarm.clock.settings.PreferencesKeys.KEY_POWER_BUTTON;
import static com.cubealarm.clock.settings.PreferencesKeys.KEY_ADVANCED_AUDIO_PLAYBACK;
import static com.cubealarm.clock.settings.PreferencesKeys.KEY_SHAKE_ACTION;
import static com.cubealarm.clock.settings.PreferencesKeys.KEY_SHAKE_INTENSITY;
import static com.cubealarm.clock.settings.PreferencesKeys.KEY_SORT_ALARM;
import static com.cubealarm.clock.settings.PreferencesKeys.KEY_SYSTEM_MEDIA_VOLUME;
import static com.cubealarm.clock.settings.PreferencesKeys.KEY_TURN_ON_BACK_FLASH_FOR_TRIGGERED_ALARM;
import static com.cubealarm.clock.settings.PreferencesKeys.KEY_VIBRATION_PATTERN;
import static com.cubealarm.clock.settings.PreferencesKeys.KEY_VIBRATION_START_DELAY;
import static com.cubealarm.clock.settings.PreferencesKeys.KEY_VOLUME_BUTTONS;
import static com.cubealarm.clock.settings.PreferencesKeys.KEY_WEEK_START;
...
import com.cubealarm.clock.AlarmSnoozeDurationDialogFragment;
import com.cubealarm.clock.AutoSilenceDurationDialogFragment;
import com.cubealarm.clock.R;
import com.cubealarm.clock.VibrationPatternDialogFragment;
import com.cubealarm.clock.VibrationStartDelayDialogFragment;
import com.cubealarm.clock.VolumeCrescendoDurationDialogFragment;
import com.cubealarm.clock.alarms.AlarmUpdateHandler;
import com.cubealarm.clock.data.DataModel;
import com.cubealarm.clock.data.SettingsDAO;
import com.cubealarm.clock.data.Weekdays;
import com.cubealarm.clock.provider.Alarm;
import com.cubealarm.clock.ringtone.RingtonePickerActivity;
import com.cubealarm.clock.utils.AlarmUtils;
import com.cubealarm.clock.utils.DeviceUtils;
import com.cubealarm.clock.utils.RingtoneUtils;
import com.cubealarm.clock.utils.Utils;
