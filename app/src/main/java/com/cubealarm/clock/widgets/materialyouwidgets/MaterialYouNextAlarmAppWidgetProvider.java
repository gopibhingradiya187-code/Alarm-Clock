...
package com.cubealarm.clock.widgets.materialyouwidgets;
...
import com.cubealarm.clock.widgets.BaseDigitalAppWidgetProvider;
import com.cubealarm.clock.widgets.DigitalWidgetSizes;
...
public class MaterialYouNextAlarmAppWidgetProvider extends BaseDigitalAppWidgetProvider {
    ...
    protected void configureBackground(RemoteViews rv, Context context, SharedPreferences prefs,
        ...
        boolean isDefaultBackgroundColor = WidgetDAO.isMaterialYouNextAlarmWidgetDefaultBackgroundColor(prefs);
