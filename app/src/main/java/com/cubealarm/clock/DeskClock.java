...
import static com.cubealarm.clock.settings.PreferencesKeys.KEY_AUTO_HOME_CLOCK;
import static com.cubealarm.clock.settings.PreferencesKeys.KEY_CLOCK_DIAL;
import static com.cubealarm.clock.settings.PreferencesKeys.KEY_CLOCK_DIAL_MATERIAL;
import static com.cubealarm.clock.settings.PreferencesKeys.KEY_CLOCK_SECOND_HAND;
import static com.cubealarm.clock.settings.PreferencesKeys.KEY_CLOCK_STYLE;
import static com.cubealarm.clock.settings.PreferencesKeys.KEY_DISPLAY_CLOCK_SECONDS;
import static com.cubealarm.clock.settings.PreferencesKeys.KEY_DISPLAY_TIMER_STATE_INDICATOR;
import static com.cubealarm.clock.settings.PreferencesKeys.KEY_ENABLE_CITY_NOTE;
...
import static com.cubealarm.clock.settings.PreferencesKeys.KEY_EXPIRED_TIMER_INDICATOR_COLOR;
import static com.cubealarm.clock.settings.PreferencesKeys.KEY_HOME_TIME_ZONE;
import static com.cubealarm.clock.settings.PreferencesKeys.KEY_KEEP_SCREEN_ON;
import static com.cubealarm.clock.settings.PreferencesKeys.KEY_PAUSED_TIMER_INDICATOR_COLOR;
import static com.cubealarm.clock.settings.PreferencesKeys.KEY_RUNNING_TIMER_INDICATOR_COLOR;
import static com.cubealarm.clock.settings.PreferencesKeys.KEY_SORT_CITIES;
import static com.cubealarm.clock.settings.PreferencesKeys.KEY_SORT_TIMER;
import static com.cubealarm.clock.settings.PreferencesKeys.KEY_SW_VOLUME_DOWN_ACTION;
import static com.cubealarm.clock.settings.PreferencesKeys.KEY_SW_VOLUME_DOWN_ACTION_AFTER_LONG_PRESS;
import static com.cubealarm.clock.settings.PreferencesKeys.KEY_SW_VOLUME_UP_ACTION;
import static com.cubealarm.clock.settings.PreferencesKeys.KEY_SW_VOLUME_UP_ACTION_AFTER_LONG_PRESS;
import static com.cubealarm.clock.settings.PreferencesKeys.KEY_TAB_INDICATOR;
import static com.cubealarm.clock.settings.PreferencesKeys.KEY_TAB_TITLE_VISIBILITY;
import static com.cubealarm.clock.settings.PreferencesKeys.KEY_TAB_TO_DISPLAY;
import static com.cubealarm.clock.settings.PreferencesKeys.KEY_WEEK_START;
import static com.cubealarm.clock.utils.AnimatorUtils.getScaleAnimator;
...
import com.cubealarm.clock.AlarmSnoozeDurationDialogFragment.SnoozeDurationDialogHandler;
import com.cubealarm.clock.AutoSilenceDurationDialogFragment.AutoSilenceDurationDialogHandler;
import com.cubealarm.clock.LabelDialogFragment.AlarmLabelDialogHandler;
import com.cubealarm.clock.LabelDialogFragment.CityNoteDialogHandler;
import com.cubealarm.clock.VolumeCrescendoDurationDialogFragment.VolumeCrescendoDurationDialogHandler;
import com.cubealarm.clock.alarms.AlarmMissedRepeatLimitDialogFragment.MissedAlarmRepeatLimitDialogHandler;
import com.cubealarm.clock.alarms.AlarmVolumeDialogFragment.VolumeValueDialogHandler;
import com.cubealarm.clock.data.DataModel;
import com.cubealarm.clock.data.DataModel.SilentSetting;
import com.cubealarm.clock.data.OnSilentSettingsListener;
...
import com.cubealarm.clock.settings.PermissionsManagementActivity;
import com.cubealarm.clock.settings.SettingsActivity;
import com.cubealarm.clock.stopwatch.StopwatchService;
import com.cubealarm.clock.timer.TimerService;
import com.cubealarm.clock.uicomponents.toast.SnackbarManager;
import com.cubealarm.clock.uidata.TabListener;
import com.cubealarm.clock.uidata.UiDataModel;
import com.cubealarm.clock.utils.InsetsUtils;
import com.cubealarm.clock.utils.ThemeUtils;

import com.cubealarm.clock.utils.Utils;
import com.cubealarm.clock.utils.WidgetUtils;
import com.cubealarm.clock.widgets.materialyouwidgets.MaterialYouNextAlarmAppWidgetProvider;
import com.cubealarm.clock.widgets.standardwidgets.NextAlarmAppWidgetProvider;
