...
import static com.cubealarm.clock.data.Timer.State.EXPIRED;
import static com.cubealarm.clock.data.Timer.State.MISSED;
import static com.cubealarm.clock.data.Timer.State.PAUSED;
import static com.cubealarm.clock.data.Timer.State.RESET;
import static com.cubealarm.clock.data.Timer.State.RUNNING;
import static com.cubealarm.clock.settings.PreferencesDefaultValues.SORT_TIMER_BY_ASCENDING_DURATION;
import static com.cubealarm.clock.settings.PreferencesDefaultValues.SORT_TIMER_BY_DESCENDING_DURATION;
import static com.cubealarm.clock.settings.PreferencesDefaultValues.SORT_TIMER_BY_NAME;
import static com.cubealarm.clock.utils.Utils.now;
import static com.cubealarm.clock.utils.Utils.wallClock;
